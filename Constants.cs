namespace Monopoly
{
    ...
    {
        public static string Connect = Environment.GetEnvironmentVariable("DB_Connect") ?? "Host=localhost;UserName=postgres;Password=5973m4b0;Database=postgres";
        public static string DBaccountName = Environment.GetEnvironmentVariable("DB_Account") ?? "AccountData";
        public static string DBroomName = Environment.GetEnvironmentVariable("DB_Room") ?? "RoomData";
        public static string DBcellName = Environment.GetEnvironmentVariable("DB_Game") ?? "GameData";
        public static string DBplayerName = Environment.GetEnvironmentVariable("DB_Player") ?? "PlayerData";
        public static string JwtKey;

        public static List<string> CellNames = new List<string>
        {
            "Старт", "Сільпо", "Мінус гроші", "Таврія В", "АТБ", "Швидка допомога", "Монобанк", "Пузата хата", "KFC", "Плюс гроші", "McDpnald`s",
            "В'язниця", "", "", "", "Приватбанк", "", "Плюс гроші", "",
            "Казино", "", "Мінус гроші", "", "", "Мінус гроші", "ПУМБ", "", "Запорізький автомобільний завод", "Плюс гроші", "Луцький автомобільний завод",
            "Відпочинок", "", "", "", "Ощадбанк", "Живчик", "Мінус гроші", "Моршинська"
        };
        public static List<string> SpecialCellNames = new List<string>
        {
            "Старт", "В'язниця", "Казино", "Відпочинок", "Мінус гроші", "Плюс гроші", "Швидка допомога", "Зворотній хід", "Торнадо"
        };
        public static List<int> CellsMonopolyIndex = new List<int>
        {
        ...
        public static List<int> CellPrices = new List<int>
        {
        ...
        public static List<int> CellStartRents = new List<int>
        {
        ...
        public static List<int> CellBaseMonopolyRents = new List<int>
        {
        ...
        public static List<int> CellLevel1Rents = new List<int>
        {
        ...
        public static List<int> CellLevel2Rents = new List<int>
        {
        ...
        public static List<int> CellLevel3Rents = new List<int>
        {
        ...
        public static List<int> CellLevel4Rents = new List<int>
        {
        ...
        public static List<int> CellLevel5Rents = new List<int>
        {
        ...
        public static List<int> CellBuildAndSellCost = new List<int>
        {
        ...
        public static List<int> CellPledgeCost = new List<int>
        {
